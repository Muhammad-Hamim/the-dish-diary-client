    ...
    <div
      ...
      <div className="flex justify-center p-8 lg:p-0 flex-col items-center bg-gray-900 bg-opacity-70 w-full">
        ...
        <p className="my-5 text-center lg:w-[40%] mx-auto text-slate-300">
          ...
          Discover new recipes, cooking techniques, and culinary inspiration to
          elevate your meals and satisfy your taste buds. Join our community of
          food lovers and explore our collection of delicious dishes from around
          the world. Let's dig in and explore the wonderful world of food
          together!
        </p>
